...
[![Build status](https://ci.appveyor.com/api/projects/status/github/criptolot/Fork-IuCoin?branch=master&svg=true)](https://ci.appveyor.com/project/RocksteadyTC/criptolot)
...
[![Build status](https://ci.appveyor.com/api/projects/status/github/criptolot/Fork-IuCoin?branch=development&svg=true)](https://ci.appveyor.com/project/RocksteadyTC/criptolot)

### Installing

We offer binary images of the latest releases here: http://cryptomoasterusa.com
...
- `export CC=gcc-8`
- `export CXX=g++-8`
- `git clone -b master --single-branch https://github.com/criptolot/Fork-IuCoin`
- `cd turtlecoin`
- `mkdir build`
- `cd build`
- `cmake ..`
...
- `cd <your_Fork-IuCoin_directory>`
- `mkdir build`
- `cd build`
- `set PATH="C:\Program Files (x86)\Microsoft Visual Studio\2017\Community\Common7\IDE\CommonExtensions\Microsoft\CMake\CMake\bin";%PATH%`
- `cmake -G "Visual Studio 15 2017 Win64" .. -DBOOST_ROOT=C:/local/boost_1_68_0`
- `MSBuild IuCoin.sln /p:Configuration=Release /m`
...
- `git clone -b master --single-branch https://github.com/criptolot/Fork-IuCoin`
- `cd Fork-IuCoin`
>>>>>>> 8ae32f783e02192cff7ccad5248d1d890383e253
- `mkdir build`
- `cd build`
- `set PATH="C:\Program Files (x86)\Microsoft Visual Studio\2017\Community\Common7\IDE\CommonExtensions\Microsoft\CMake\CMake\bin";%PATH%`
...
#### Thanks
Cryptonote Developers, Bytecoin Developers, Monero Developers, Forknote Project, TurtleCoin Community, IuCoin Project
...
// Copyright (c) 2019, The IuCoin Developers
>>>>>>> 8ae32f783e02192cff7ccad5248d1d890383e253
//
